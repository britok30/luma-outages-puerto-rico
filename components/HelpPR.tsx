    ...
    <div className="mt-10 flex flex-col text-md justify-center items-center">
      ...
      <div className="w-full md:w-1/3 text-left">
        <p className="mb-4 font-light text-gray-400 hover:text-white transition duration-200 ease-in-out">
          Brigada Solidaria del Oeste recolecta donaciones de emergencia
        ...
        <p className="mb-4 font-light text-gray-400 hover:text-white transition duration-200 ease-in-out">
          Taller Salud, una organización sin fines de lucro, dirigida por
          mujeres con sede en Loíza, Puerto Rico, está aceptando donaciones de
          alimentos no perecederos, recipientes desechables, galones de agua,
          pañales para adultos y bebés, y más. El grupo también acepta
          donaciones en efectivo a través de PayPal y algunos elementos
        ...
        <p className="mb-4 font-light text-gray-400 hover:text-white transition duration-200 ease-in-out">
          Global Giving, una organización sin fines de lucro que apoya y conecta
          a otras organizaciones sin fines de lucro con donantes, lanzó el
          "Fondo de ayuda para el huracán Fiona", con el objetivo de recaudar $
        ...
        <p className="mb-4 font-light text-gray-400 hover:text-white transition duration-200 ease-in-out">
          Hispanic Federation, una organización sin fines de lucro, que brinda
          apoyo a las comunidades latinas en los EE. UU., dice que la
        ...
        <p className="mb-4 font-light text-gray-400 hover:text-white transition duration-200 ease-in-out">
          PRxPR Relief and Rebuild Fund, lanzado a raíz del huracán María por
          líderes empresariales puertorriqueños en los EE. UU., trabaja con
        ...
        <p className="mb-4 font-light text-gray-400 hover:text-white transition duration-200 ease-in-out">
          Techos Pa' Mi Gente es una organización sin fines de lucro que comenzó
