      ...
      <div className="bg-white rounded-lg border border-gray-200 p-5">
        ...
        <ResponsiveContainer width="100%" height={280}>
          ...
          >
            ...
            />
            <Tooltip
              formatter={(value) => [`$${Number(value).toLocaleString()}`, "Median Earnings"]}
              contentStyle={{
                borderRadius: "8px",
