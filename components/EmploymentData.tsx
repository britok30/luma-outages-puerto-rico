    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
        <div className="bg-white rounded-lg border border-gray-200 border-l-4 border-l-blue-500 p-5">
          <p className="text-sm text-gray-500">Labor Force Participation | Participación en Fuerza Laboral</p>
          <p className="text-2xl font-bold tabular-nums mt-1">
            {data.laborForceRate}%
          </p>
        </div>
        <div className="bg-white rounded-lg border border-gray-200 border-l-4 border-l-emerald-500 p-5">
          <p className="text-sm text-gray-500">Employment Ratio | Tasa de Empleo</p>
          <p className="text-2xl font-bold tabular-nums mt-1">
            {data.employmentRatio}%
          </p>
        </div>
        <div className="bg-white rounded-lg border border-gray-200 border-l-4 border-l-red-500 p-5">
          <p className="text-sm text-gray-500">Unemployment Rate | Tasa de Desempleo</p>
          <p className="text-2xl font-bold tabular-nums mt-1">
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-5">
        <h3 className="text-sm font-medium text-gray-500 mb-4">
          Employment Indicators | Indicadores de Empleo (Population 16+ | Población 16+:{" "}
        ...
        <ResponsiveContainer width="100%" height={280}>
          ...
          >
            ...
            />
            <Tooltip
              formatter={(value) => [`${value}%`, "Rate | Tasa"]}
              contentStyle={{
                borderRadius: "8px",
